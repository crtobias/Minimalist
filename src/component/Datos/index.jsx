       ...
       <section id={props.id} className={styles[`container-datos`]}>
        <section className={styles[`container-datos-info-foto`]}>
            ...
            <h1 className={styles.name}>
               ...
               <a href="https://www.linkedin.com/in/tobias-gonzalez-arriola-0a2399273/details/featured/1708976663788/single-media-viewer/?type=DOCUMENT&profileId=ACoAAELMajoBaczBg1nQxeFzVhpa_y0mSZCTvgY" target="_blank"> <p className={BlackMode ? styles[`cv-black`] : styles[`cv-light`]}>cv</p></a>
            </h1>
        </section>
